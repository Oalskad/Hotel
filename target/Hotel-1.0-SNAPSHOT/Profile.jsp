                        ...
                        <div class="u-layout-col">
                            ...
                            <div class="u-container-style u-gradient u-layout-cell u-size-30 u-layout-cell-2">
                                <div class="u-border-2 u-border-grey-75 u-container-layout u-container-layout-2">
                                    <p class="u-text u-text-3">Name:<b> ${sessionScope.userDTO.userName}</b> <br>
                                    </p>
                                    <p class="u-text u-text-4">Phone number:<b> ${sessionScope.userDTO.phoneNumber}</b> <br>
                                    </p>
                                         <p class="u-text u-text-3">First Name : <b>${sessionScope.userDTO.fname}</b>  <br>
                                    </p>
                                    <p class="u-text u-text-3">Last Name : <b>${sessionScope.userDTO.lname}</b>  <br>
                                    </p>
                                    ...
                                    <p class="u-text u-text-6">Description:<br>
                                    </p>
                                    <p class="u-text u-text-7" >Date of Birth: <b>${sessionScope.userDTO.dayOfBirth}</b>  <br>
                                    </p>
                                    <p class="u-text u-text-8">Gender: <b>${sessionScope.userDTO.gender}</b><br>
                                    </p>
                                    <p class="u-text u-text-9">Email: <b>${sessionScope.userDTO.email}</b><br>
                                    </p>
                                </div>
                            </div>
                        </div>
