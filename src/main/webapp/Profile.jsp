            ...
            <div class="u-layout-col">
              ...
              <div class="u-container-style u-gradient u-layout-cell u-size-30 u-layout-cell-2">
                <div class="u-border-2 u-border-grey-75 u-container-layout u-container-layout-2">
                  <p class="u-text u-text-3">Name:<br>
                  </p>
                  <p class="u-text u-text-4">Phone number:<br>
                  </p>
                  ...
                  <p class="u-text u-text-7">Date of Birth:<br>
                  </p>
                  <p class="u-text u-text-8">Gender:<br>
                  </p>
                  <p class="u-text u-text-9">Email:<br>
                  </p>
                </div>
              </div>
            </div>
